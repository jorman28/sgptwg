...
public class ActividadesDao {
    ...
    public List<ActividadesBean> consultarActividades(Integer id, Integer version, String descripcion, java.util.Date fecha_estimada_inicio, java.util.Date fecha_estimada_terminacion, java.util.Date fecha_real_inicio, java.util.Date fecha_real_terminacion, java.util.Date tiempo_estimado, java.util.Date tiempo_invertido, Integer estado) throws ClassNotFoundException, InstantiationException, SQLException, IllegalAccessException {
        ...
        while (rs.next()) {
            ...
            actividad.setTiempo_estimado(rs.getDate("tiempo_estimado"));
            actividad.setTiempo_invertido(rs.getDate("tiempo_invertido"));
    ...
    public int crearActividad(ActividadesBean actividad) throws ClassNotFoundException, InstantiationException, SQLException, IllegalAccessException {
        ...
        ps.setDate(7, new Date(actividad.getTiempo_estimado().getTime()));
        ps.setDate(8, new Date(actividad.getTiempo_invertido().getTime()));
    ...
    public int actualizarActividad(ActividadesBean actividad) throws ClassNotFoundException, InstantiationException, SQLException, IllegalAccessException {
        ...
        ps.setDate(6, new Date(actividad.getTiempo_estimado().getTime()));
        ps.setDate(7, new Date(actividad.getTiempo_invertido().getTime()));
