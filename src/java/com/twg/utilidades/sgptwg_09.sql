...
INSERT INTO permisos (id, pagina, permiso) VALUES (34, (SELECT id FROM paginas WHERE nombre = 'Versiones'), 'ELIMINAR_PROYECTO');
INSERT INTO permisos (id, pagina, permiso) VALUES (35, (SELECT id FROM paginas WHERE nombre = 'Versiones'), 'CREAR_VERSION');
INSERT INTO permisos (id, pagina, permiso) VALUES (36, (SELECT id FROM paginas WHERE nombre = 'Versiones'), 'ELIMINAR_VERSION');
INSERT INTO permisos (id, pagina, permiso) VALUES (37, (SELECT id FROM paginas WHERE nombre = 'Versiones'), 'COMENTAR');
INSERT INTO permisos (id, pagina, permiso) VALUES (38, (SELECT id FROM paginas WHERE nombre = 'Actividades'), 'CONSULTAR');
INSERT INTO permisos (id, pagina, permiso) VALUES (39, (SELECT id FROM paginas WHERE nombre = 'Actividades'), 'CREAR');
INSERT INTO permisos (id, pagina, permiso) VALUES (40, (SELECT id FROM paginas WHERE nombre = 'Actividades'), 'ELIMINAR');
INSERT INTO permisos (id, pagina, permiso) VALUES (41, (SELECT id FROM paginas WHERE nombre = 'Actividades'), 'GUARDAR');
INSERT INTO permisos (id, pagina, permiso) VALUES (42, (SELECT id FROM paginas WHERE nombre = 'Actividades'), 'COMENTAR');