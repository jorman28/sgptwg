...
public class Templates {
    ...
    public static final StyleBuilder italicStyle12;
    ...
    static {
        ...
        italicStyle12 = stl.style(rootStyle).italic().setFontSize(12);
        ...
        reportTemplate = template()
                ...
                .setTitleStyle(rootStyle);

        currencyType = new CurrencyType();

        dynamicReportsComponent = cmp.horizontalList(cmp.verticalList(
                cmp.text("Think Web & Games")
                .setStyle(bold16CenteredStyle)
                .setHorizontalTextAlignment(HorizontalTextAlignment.RIGHT),
                cmp.text("sgptwg-thinkwg.rhcloud.com")
                .setStyle(italicStyle12)
                .setHorizontalTextAlignment(HorizontalTextAlignment.RIGHT),
                cmp.text("")), cmp.image(Templates.class.getResource("logo.png"))
                .setFixedDimension(60, 60)).setFixedWidth(300);
    ...
    public static ComponentBuilder<?, ?> createTitleComponent(String label) {
        return cmp.horizontalList()
                .add(cmp.text(label)
                        ...
                        .setHorizontalTextAlignment(HorizontalTextAlignment.LEFT), dynamicReportsComponent)
                .newRow()
                .add(cmp.line())
                .newRow()
